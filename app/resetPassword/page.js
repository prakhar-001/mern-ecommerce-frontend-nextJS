...
const page = () => {
  ...
  return (
    ...
    {/* <NotLoggedInCustomerOnlyLayout> */}
        <div className='flex items-center flex-col justify-between mt-20 sm:mt-10 mx-auto border-2 shadow-2xl h-auto mb-20 rounded-xl w-11/12 sm:w-2/5 p-10 sm:p-10'>
